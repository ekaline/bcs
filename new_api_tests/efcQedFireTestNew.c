...
int main(int argc, char *argv[]) {
  ...
  EfcInitCtx initCtx = {.feedVer = EfhFeedVer::kQED};
  ...
  static const uint64_t QEDTestPurgeToken =
      0x1122334455667788;
  static const uint64_t QEDTestPurgeUser =
      0xaabbccddeeff0011;
  ...
  rc = efcSetAction(dev, qedHwPurgeIdx,
                    &genericActionParams);
  if (rc != EKA_OPRESULT__OK)
  ...
  params.product[active_set].min_num_level =
      QEDTestMinNumLevel;
