...
static GroupAddr group[] = {
    ...
    {inet_addr("233.104.73.8"), 18008, 0, 0},
    {inet_addr("233.104.73.9"), 18009, 0, 0},
    {inet_addr("233.104.73.10"), 18010, 0, 0},
    {inet_addr("233.104.73.11"), 18011, 0, 0},
    {inet_addr("233.104.73.12"), 18012, 0, 0},
    {inet_addr("233.104.73.13"), 18013, 0, 0},
    {inet_addr("233.104.73.14"), 18014, 0, 0},
    {inet_addr("233.127.56.15"), 18015, 0, 0},
