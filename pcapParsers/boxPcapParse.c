...
static GroupAddr group[] = {
    // Vanilla A
    {inet_addr("224.0.124.1"), 21401, {}, 0},
    {inet_addr("224.0.124.2"), 22401, {}, 0},
    {inet_addr("224.0.124.3"), 23401, {}, 0},
    {inet_addr("224.0.124.4"), 24401, {}, 0},
    {inet_addr("224.0.124.5"), 25401, {}, 0},
    {inet_addr("224.0.124.6"), 26401, {}, 0},
    {inet_addr("224.0.124.7"), 27401, {}, 0},
    {inet_addr("224.0.124.8"), 28401, {}, 0},

    // Vanilla B
    {inet_addr("224.0.124.49"), 21404, {}, 0},
    {inet_addr("224.0.124.50"), 22404, {}, 0},
    {inet_addr("224.0.124.51"), 23404, {}, 0},
    {inet_addr("224.0.124.52"), 24404, {}, 0},
    {inet_addr("224.0.124.53"), 25404, {}, 0},
    {inet_addr("224.0.124.54"), 26404, {}, 0},
    {inet_addr("224.0.124.55"), 27404, {}, 0},
    {inet_addr("224.0.124.56"), 28404, {}, 0},

    // RFQ (PIP) A   
    {inet_addr("224.0.124.17"), 21403, {}, 0},
    {inet_addr("224.0.124.18"), 22403, {}, 0},
    {inet_addr("224.0.124.19"), 23403, {}, 0},
    {inet_addr("224.0.124.20"), 24403, {}, 0},
    {inet_addr("224.0.124.21"), 25403, {}, 0},
    {inet_addr("224.0.124.22"), 26403, {}, 0},
    {inet_addr("224.0.124.23"), 27403, {}, 0},
    {inet_addr("224.0.124.24"), 28403, {}, 0},

    // Complex (Strategy) A   
    {inet_addr("224.0.124.25"), 21407, {}, 0},
    {inet_addr("224.0.124.26"), 22407, {}, 0},
    {inet_addr("224.0.124.27"), 23407, {}, 0},
    {inet_addr("224.0.124.28"), 24407, {}, 0},
    {inet_addr("224.0.124.29"), 25407, {}, 0},
    {inet_addr("224.0.124.30"), 26407, {}, 0},
    {inet_addr("224.0.124.31"), 27407, {}, 0},
    {inet_addr("224.0.124.32"), 28407, {}, 0},
