...
struct itto_generic_header { // Dummy
  char		type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
} __attribute__((packed));

/* struct itto_time_stamp { // obsolete */
/* 	char		type; */
/* 	uint32_t	time_sec; // number of seconds since midnight */
/* } __attribute__((packed)); */

struct itto_system_event { // 'S'
  char		type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
  char		event_code;       // 1
...
/* struct itto_base_reference { // obsolete */
/* 	char		type; */
/* 	char	        time_nano[6]; */
/* 	uint64_t	reference; */
/* } __attribute__((packed)); */

struct itto_definition { // 'R'
  char		type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
...
struct itto_message_replace_short {  // 'u'
  char          type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
...
struct itto_message_replace_long {  // 'U'
  char          type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
  uint64_t	original_reference_delta; // 8
...
struct itto_quote_replace_short {  // 'k'
  char          type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
...
struct itto_quote_replace_long {  // 'K'
  char          type;             // 1
  uint16_t      tracking_num;     // 2
  char	        time_nano[6];     // 6
  uint64_t	original_bid_delta; // 8
