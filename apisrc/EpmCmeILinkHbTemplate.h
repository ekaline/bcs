#ifndef _EPM_CME_ILINK_HB_TEMPLATE_H_
#define _EPM_CME_ILINK_HB_TEMPLATE_H_

#include "EpmTemplate.h"

class EpmCmeILinkHbTemplate : public EpmTemplate {
 public:
 EpmCmeILinkHbTemplate(uint idx) : EpmTemplate(idx) {
      ...
      /* --------------------------- */
      {"Prefix" ,                      8, HwField::IMMEDIATE,    false, false }, // common prefix at ILink HB msgs
    ...
    strcpy(name,"EpmCmeILinkHbTemplate");
    init();
  }
