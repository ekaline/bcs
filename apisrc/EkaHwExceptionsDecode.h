...
inline int ekaDecodeExceptions(char* dst,const EfcExceptionsReport* excpt) {
  ...
  if ((excpt->exceptionStatus.globalVector>>5 )&0x1) d += sprintf(d,"Bit 5: P4 Controller Watchdog Expired\n" );
  ...
  if ((excpt->exceptionStatus.globalVector>>9 )&0x1) d += sprintf(d,"Bit 9: P4 Strategy Double Fire Protection Triggered\n" );
  ...
  if ((excpt->exceptionStatus.globalVector>>27)&0x1) d += sprintf(d,"Bit 27: NW Controller Watchdog Expired\n" );
  if ((excpt->exceptionStatus.globalVector>>28)&0x1) d += sprintf(d,"Bit 28: NW Strategy Double Fire Protection Triggered\n" );
