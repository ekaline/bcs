#ifndef _EKA_FH_MIAX_MESSAGES_H
#define _EKA_FH_MIAX_MESSAGES_H
#include <stdint.h>
#include <unistd.h>
...
enum class EKA_MIAX_TOM_MSG : char {
  Time = '1',
    SeriesUpdate = 'P',
    SystemState = 'S',
    BestBidShort = 'B',
...
inline bool operator==(const EKA_MIAX_TOM_MSG lhs, const uint8_t rhs) noexcept {
  return ((uint8_t)lhs) == rhs;
}
inline bool operator==(const uint8_t lhs, const EKA_MIAX_TOM_MSG rhs) noexcept {
...
#define EKA_GET_MACH_SEQ(x) (((EkaMiaxMach*)(x))->sequence)
