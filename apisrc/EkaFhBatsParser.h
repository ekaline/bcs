...
#define EKA_BATS_PITCH_MSG_DECODE(x)					\
  x == EKA_BATS_PITCH_MSG::SYMBOL_MAPPING                 ? "SYMBOL_MAPPING" : \
    ...
    x == EKA_BATS_PITCH_MSG::WIDTH_UPDATE                 ? "WIDTH_UPDATE" : \
    x == EKA_BATS_PITCH_MSG::AUCTION_UPDATE               ? "AUCTION_UPDATE" : \
    x == EKA_BATS_PITCH_MSG::OPTIONS_AUCTION_UPDATE       ? "OPTIONS_AUCTION_UPDATE" : \
    x == EKA_BATS_PITCH_MSG::AUCTION_SUMMARY              ? "AUCTION_SUMMARY" : \
    x == EKA_BATS_PITCH_MSG::AUCTION_NOTIFICATION         ? "AUCTION_NOTIFICATION" : \
    x == EKA_BATS_PITCH_MSG::AUCTION_CANCEL               ? "AUCTION_CANCEL" : \
    x == EKA_BATS_PITCH_MSG::AUCTION_TRADE                ? "AUCTION_TRADE" : \
    x == EKA_BATS_PITCH_MSG::UNIT_CLEAR                   ? "UNIT_CLEAR" : \
    x == EKA_BATS_PITCH_MSG::RETAIL_PRICE_IMPROVEMENT     ? "RETAIL_PRICE_IMPROVEMENT" : \
    x == EKA_BATS_PITCH_MSG::SOQ_STRIKE_RANGE_UPDATE      ? "SOQ_STRIKE_RANGE_UPDATE" : \
    x == EKA_BATS_PITCH_MSG::CONSTITUENT_SYMBOL_MAPPING   ? "CONSTITUENT_SYMBOL_MAPPING" : \
    x == EKA_BATS_PITCH_MSG::UNIT_CLEAR                   ? "UNIT_CLEAR" :		\
    x == EKA_BATS_PITCH_MSG::TRANSACTION_BEGIN            ? "TRANSACTION_BEGIN" : \
    x == EKA_BATS_PITCH_MSG::TRANSACTION_END              ? "TRANSACTION_END" :	\
    "NON_INTERESTING"
