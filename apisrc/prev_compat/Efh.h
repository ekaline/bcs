 ...
 * @param excCtx   This is the EkacCtx obtained for the core
 ...
 */
EkaOpResult efhInit( EfhCtx** ppEfhCtx, EkaCtx* excCtx, const EfhInitCtx* initCtx );
...
EkaOpResult efhMonitorFhGroupState( EfhCtx* efhCtx, uint8_t group);
